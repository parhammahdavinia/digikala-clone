  ...
  return (
    <>
      <div className="w-full cursor-pointer">
        <img
          src="https://dkstatics-public.digikala.com/digikala-adservice-banners/2b65815eaafa77de41ccc8b503af011de9a24574_1709390614.jpg?x-oss-process=image/quality,q_95"
          alt=""
        />
      </div>
      {/* end of banner */}
          ...
          <div className="w-full flex container-4xl-w mx-auto px-4-md justify-between">
            ...
            <div className="flex felx-row justify-between mr-auto lg:w-20 my-auto">
              <div className="flex flex-nowrap">
                ...
                {<p className="text-xs">ارسال به گیشا</p>}
